...
CONFIG_PATH = BASE_DIR / "config" / environ.get("BOARD_CONF", "config.ini")

if not CONFIG_PATH.is_file():
    raise ImproperlyConfigured(
        f"Config file with specified path not found: {CONFIG_PATH}"
    )
...
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "posts.pagination.CustomLimitOffsetPagination",
    "PAGE_SIZE": 30,
